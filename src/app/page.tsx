    ...
    <div className="min-h-screen w-full bg-neo text-slate-700 dark:text-slate-200 font-sans selection:bg-blue-200 overflow-x-hidden">
      ...
      <nav className="relative z-10 w-full px-4 md:px-8 py-4 md:py-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold tracking-wide">Resume Builder</span>
        </div>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 pt-8 sm:pt-16 pb-16 sm:pb-24 flex flex-col lg:flex-row items-center gap-8 sm:gap-16">
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left z-10">
          ...
          <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 font-medium mb-10 max-w-xl leading-relaxed">
            Stand out from the crowd with a beautifully crafted, ATS-friendly resume. No sign-up required.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-8">
          ...
          <div className="space-y-6">
            <div className="bg-neo shadow-neo-convex rounded-3xl p-8 border border-white/20">
              ...
              <p className="text-slate-500 dark:text-slate-400">Yes! Resume Builder is 100% free and open-source. There are no hidden fees, subscriptions, or watermarks on your exported PDFs.</p>
            </div>
            <div className="bg-neo shadow-neo-convex rounded-3xl p-8 border border-white/20">
      ...
      <footer className="relative z-10 w-full py-8 border-t border-slate-300/30 bg-neo flex flex-col items-center gap-4">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-medium">© {new Date().getFullYear()} Resume Builder.</p>
      </footer>
    </div>
  )
}
